...
class SendMail(threading.Thread):
    def __init__(self, receiver: str, receiverName: str, title: str, mailContext: str, sender: str = SENDER,
                 host: str = DEFAULT_HOST, textType: str = DEFAULT_TEXT_TYPE, codec: str = DEFAULT_CODEC) -> None:
        super().__init__()
